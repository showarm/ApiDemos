...
import com.example.android.util.NetworkUtils;
...
public class LoaderRygActivity extends Activity implements OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loaderryg);
        initData();
        initView();
        mImageLoader = ImageLoader.build(LoaderRygActivity.this);
    }
    ...
    private void initData() {
        ...
        int space = ScreenUtils.dip2px(this, 20f);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        private ImageAdapter(Context context) {
            ...
            mDefaultBitmapDrawable = context.getResources().getDrawable(R.drawable.ic_contact_picture);
        }
