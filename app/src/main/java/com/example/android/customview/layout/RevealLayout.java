...
public class RevealLayout extends LinearLayout implements Runnable {
    ...
    /**
     * dispatchDraw时机：在viewGroup的draw之后，child view的draw之前
     * @param canvas
     */
    @Override
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.save();
        canvas.clipRect(left, top, right, bottom);//裁剪出mTouchTarget所在的Rect
        canvas.drawCircle(mCenterX, mCenterY, mRevealRadius, mPaint);
        canvas.restore();
    ...
    private View getTouchTarget(View view, int x, int y) {
        View target = null;
//       return all touchable views that are descendants of this view
