 ...
 *
 */
public class QQRedTipView extends FrameLayout {
    ...
    public QQRedTipView(Context context) {
        super(context);
        init();
    }

    public QQRedTipView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public QQRedTipView(Context context, AttributeSet attrs, int defStyleAttr) {
