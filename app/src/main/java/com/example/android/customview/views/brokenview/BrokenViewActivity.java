package com.example.android.customview.views.brokenview;
...
public class BrokenViewActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(BrokenViewActivity.this,"Button onClick",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initDrawerLayout(){
        ...
        ActionBarDrawerToggle mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                toolbar, R.string.activity_sample_code, R.string.activity_sample_code) {
            @Override
    ...
    public void refreshDate(){
        ...
        listView.setAdapter(new SampleAdapter(BrokenViewActivity.this, android.R.layout.simple_list_item_1, items));
    ...
    */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_brokenview, menu);
        return true;
    }
