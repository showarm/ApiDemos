package com.example.android.customview.views.mtextview;
...
public class MTextViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mtextview);
    ...
    private void Test() {
        ...
        for (int i = 0; i < source.length() - 2; i += plus) {
            ...
            ImageSpan is = new ImageSpan(MTextViewActivity.this, R.drawable.emoji_29);
