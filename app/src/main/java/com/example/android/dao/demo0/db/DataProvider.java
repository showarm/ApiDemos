...
public class DataProvider extends ContentProvider {
    ...
    private static SqliteDbHelper mDataBaseHelper;

    public static SqliteDbHelper getDataBaseHelper(Context context) {
    ...
    private String matchTable(Uri uri) {
        ...
        switch (uriMatcher.match(uri)) {
            case ITEMS:
                table = DataProviderHelper.ItemDBInfo.TABLE_NAME;
                break;
            default:
                break;
        }
