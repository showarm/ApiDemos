 ...
 */
public abstract class RecyclerBaseCursorAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements Filterable,
     ...
     */
    public RecyclerBaseCursorAdapter(Context context, Cursor c) {
     ...
     */
    public RecyclerBaseCursorAdapter(Context context, Cursor c, int flags) {
